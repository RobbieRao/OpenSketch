<template>
  ...
  <view class=" container" style="display: flex; flex-direction: column;align-items: center;">
    ...
    <view class="content" style="display: flex; flex-direction: column ;align-items: left;width: 100%; height: 1000rpx;"
      ...
      <text class="text"
        style="margin-left: 20rpx; font-size:72rpx;font-weight: bolder;color:#000000 ; line-height: 100rpx; font-family: 'hh';">With
        AI</text>
      <text class="text"
        style="margin-left: 20rpx; font-size:72rpx;font-weight: bolder;color:#000000 ; font-family: 'hh'">Create your
        own swimming elf!</text>

      <button class="button" @click="startAnimation"
        style=" position: absolute; font-family: 'hh'; display: flex; flex-direction: column; justify-content: center; text-align: center;align-items: center; bottom: 50rpx;">START</button>
      <button class="button2" @click="switchCN"
  ...
  height: 80rpx; " />
    ...
    <view class="content"
      ...
      <view class="">
        <text class="text"
          style="margin-left: 20rpx; font-size:72rpx;font-weight: bolder;color:#000000 ; line-height: 100rpx; font-family: 'hh';">Choose
          an </text>
        <text class="text"
          style=" font-size:72rpx;font-weight: bolder;color:#000000 ; line-height: 100rpx; font-family: 'hh';color: #ff4583; ">{{ themeCC  ? themeCC : 'animal'}}</text>
      </view>
      <text class="text"
        style="margin-left: 20rpx; font-size:72rpx;font-weight: bolder;color:#000000 ; font-family: 'hh'">As a
        theme!</text>
    </view>
  ...
  export default {
    ...
    methods: {
      ...
      handleImageTap(index) {
        ...
        const textsCC = ['sea ​​urchin', 'starfish', 'Crab',
          'whale', 'dolphin', 'jellyfish'
        ]; // 每个 index 对应的文本值
