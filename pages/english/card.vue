<template>
  ...
  <view class="content" style=" position:relative; ">
    ...
    <view class="header"
      ...
      <text class="floating-text" style="font-family: 'ht'; font-size: 68rpx; line-height: 160rpx;">
        {{ inputText ? inputText : 'Swimming sprite！' }}
      </text>
      <text class="floating-text" style="font-family: 'ht';font-size: 36rpx; line-height: 50rpx;">泳动精灵</text>
      <text class="floating-text" style="font-family: 'ht';font-size: 36rpx;line-height: 50rpx;">@！Asian Games</text>
    </view>
    ...
    <view class="name-card"
      ...
      <view class="" style="position: relative; text-align: right;">
        <text class="number"
          style="font-size: 36rpx;margin: 15rpx; font-weight: 100;  letter-spacing: 15rpx;">{{username}}'s</text>
        <b></b>
        <text class="number"
          style=" background-color: #ff007f;color: #ffffff; font-size: 48rpx;margin: 15rpx;letter-spacing: 2rpx; line-height: 110rpx; ">{{ inputText ? inputText : 'Swiming sprite' }}</text>
        <b></b>
        <text class="number" style="font-size: 32rpx; margin: 15rpx; font-weight: 100;">{{ currentDate }}</text>
      </view>
    ...
    <!-- 自由文字 -->
    <text
      style="position: absolute;font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif; font-weight: 100;font-size: 48rpx;writing-mode: vertical-lr;right: 10rpx">Co-create
      with AI</text>
    <text
      style="position: absolute;font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;  width: 20rpx; height: 1000rpx; font-weight: 100;font-size: 48rpx;writing-mode: vertical-lr;left: 10rpx;top: 500rpx;">Spawn
      your swimming Sprite</text>
    ...
    <view class="slider" style="position: absolute;right: 60rpx;top: 1250rpx;">
      ...
      <view class="sliderB"
        ...
        <text
          style="position: absolute;right: 100rpx; font-family: 'hh';writing-mode:sideways-lr; text-orientation:sideways;color:#aeaeae; font-size: 24rpx;">Launch
          sprites!</text>
        <!-- 进度条 -->
    ...
    methods: {
      ...
      onShareButtonClick() {
        ...
        uni.share({
            title: '分享标题',
            content: '分享内容',
            path: '/pages/english/draw' // 当前页面的路径，可根据实际情况进行修改
          })
          .then(() => {
            // 分享成功的回调
            console.log('分享成功');
      ...
      upLoadWaiting() {
        ...
        setTimeout(() => {
          ...
          uni.showModal({
            title: 'It worked!',
            content: `Residual degree(${this.uploadCount})`,
