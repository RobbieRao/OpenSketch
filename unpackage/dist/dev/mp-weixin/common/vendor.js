...
const pages = [
  {
    path: "pages/draw/start",
    style: {
      navigationBarTitleText: "泳动世界",
...
const b = true, k = "mp-weixin", T = S([]), P = k, A = S('{\n    "address": [\n        "127.0.0.1",\n        "192.168.137.1",\n        "10.61.79.168"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "E:/HBuilderX.3.8.4.20230531/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), E = S('[{"provider":"aliyun","spaceName":"hubin","spaceId":"mp-b56cf8d8-2940-4edf-b3b5-52d427ee6713","clientSecret":"kQGJ1xCM+sPVV/JE9QY98w==","endpoint":"https://api.next.bspapp.com"}]') || [];
let x = "";
try {
  x = "__UNI__AFADA37";
} catch (e2) {
