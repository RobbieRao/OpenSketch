...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    b: $data.changecolor,
    c: $data.changecolor,
    d: common_vendor.t($data.inputText ? $data.inputText : "Swimming sprite！"),
    ...
    i: common_vendor.t($data.inputText ? $data.inputText : "Swiming sprite"),
    j: common_vendor.t($data.currentDate),
    k: common_vendor.o((...args) => $options.onShareButtonClick && $options.onShareButtonClick(...args)),
    l: common_vendor.s($options.sliderStyle),
    m: common_vendor.s($options.buttonStyle),
    n: common_vendor.s({
      "pointer-events": $data.uploadCount === 0 ? "none" : "auto"
    }),
    o: common_vendor.o((...args) => $options.onTouchStart && $options.onTouchStart(...args)),
    p: common_vendor.o((...args) => $options.onTouchMove && $options.onTouchMove(...args)),
    q: common_vendor.o((...args) => $options.onTouchEnd && $options.onTouchEnd(...args))
  });
}
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "E:/湖滨街道小程序开发/hubinPING/pages/english/card.vue"]]);
