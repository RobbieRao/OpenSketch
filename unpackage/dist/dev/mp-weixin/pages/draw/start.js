...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    q: common_vendor.o((...args) => $options.switchEnglish && $options.switchEnglish(...args)),
    r: $data.textanimate,
    s: $data.confirmaimate,
    t: common_vendor.o((...args) => $options.godraw && $options.godraw(...args)),
    v: common_vendor.t($data.themeCC ? $data.themeCC : "小动物"),
    w: $data.chooseTxt
  };
}
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "E:/湖滨街道小程序开发/hubinPING/pages/draw/start.vue"]]);
